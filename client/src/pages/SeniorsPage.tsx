                ...
                <div className="bg-neutral-900 w-full max-w-[95vw] p-6 rounded-lg shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {seniors.map((senior) => (
                            ...
                            >
                                <div
                                    className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow mb-3">
                                    {senior.photoUrl ? (
                                        <img
                                            src={senior.photoUrl}
                                            alt={senior.name}
                                        ...
                                        <div
                                            className="w-full h-full bg-gray-500 flex items-center justify-center text-2xl font-bold text-white">
                                ...
                                {senior.isTopMentor && (
                                    <span
                                        className="mt-2 bg-yellow-400 text-white text-xs px-3 py-1 rounded-full font-bold">
                    🌟 Top Mentor
                  </span>
                                )}
