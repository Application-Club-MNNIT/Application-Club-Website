                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="flex gap-5 md:gap-3 flex-col min-w-full">
                            {inputFields.map((field) => (
                                <div key={field.name}
                                     className="flex flex-col md:grid grid-cols-[1fr_2fr] gap-1 md:gap-4">
                                    <label
                                        className="flex items-center justify-center gap-1 text-center mb-2 md:justify-self-end md:text-left">
                                        <img src={field.icon} className="h-5 w-5" alt={field.name}/>
