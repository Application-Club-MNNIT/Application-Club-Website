  ...
  const winnersList = [
    {
      ...
      names: [
        {
          value: "Chinmay Borah 2024CA030",
          linkedin: "chinmay-borah-46a865229",
        },
        {
          value: "Manish sharma 2024CA053",
          linkedin: "manish-sharma26",
        },
        {
          value: "Shubham gupta 2024CA097",
          linkedin: "shubham-gupta-593787219",
        },
        {
          value: "Sanyam Goel 2024CA091",
          linkedin: "iamsanyamgoel",
        },
      ],
    },
    {
      ...
      names: [
        {
          value: "Bankim Chandra Das 2024CA026",
          linkedin: "bankim-ch",
        },
      ],
    },
    {
      ...
      names: [
        {
          value: "Vishal Minj 2024CA113",
          linkedin: "vishal-minj-a8106825b",
        },
      ],
    },
    {
      ...
      names: [
        {
          value: "Suchismita Roy 2024CA102",
          linkedin: "suchismita-roy-b74254319",
        },
      ],
    },
    {
      ...
      names: [
        ...
        {
          value: "Mayank Agarwal 2024CA054",
          linkedin: "amayank071",
        },
      ],
    },
    ...
    <div className="flex w-full items-center align-middle justify-center">
      <div className="max-w-[2400px] w-full">
        ...
        <div className="relative min-h-[80vh] bg-gradient-to-br from-black via-neutral-900 to-black text-white">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_1px_1px,_rgb(200,200,200)_1px,_transparent_0)] bg-[size:40px_40px]"></div>
          ...
          <div className="relative flex flex-col items-center justify-center px-4 py-20 sm:py-32">
            ...
            <div className="max-w-4xl text-center space-y-6">
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
                A student-led initiative at MNNIT Allahabad where selected MCA
                students annually take on leadership roles to mentor and upskill
                their juniors.
              </p>
              <p className="text-base sm:text-lg text-gray-400">
                Dedicated to upskill and guide freshmen of MNNIT Allahabad in
            ...
            <div className="flex flex-wrap gap-4 mt-12 justify-center">
              <NavLink
                to="/signup"
                className="px-8 py-3 bg-AC_Orange text-black font-semibold rounded-lg
              ...
              <a
                href="#logos"
                className="px-8 py-3 bg-transparent text-white font-semibold rounded-lg
        ...
        {winnersList.length > 0 && (
          <div className="max-w-7xl px-4 pb-10 w-full mx-auto">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              Our Achievers
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
              {winnersList.map((data) => (
                <WinnersTile key={data.text1 + data.text2} data={data} />
              ))}
            </div>
          </div>
        )}
