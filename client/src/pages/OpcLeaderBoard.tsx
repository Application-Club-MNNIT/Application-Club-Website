            ...
            try {
                ...
                actualData = {
                    ...
                    opc6: [
                        ...
                        {
                            rank: 12,
                            name: "Team: Dukh Dard Peeda Kasht!! ",
                            username: "Dukh Dard Peeda Kasht!!",
                            solved: 1
                        },
                ...
                <div className="min-w-[80vw] min-h-screen bg-gray-900 w-full">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-8 max-w-full">
                        ...
                        <div className="flex items-center justify-center mb-4 sm:mb-8">
                            ...
                            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white font-poltawski">OPC
                                Leaderboard</h1>
                        </div>
                        ...
                        <div className="flex justify-center mb-4 sm:mb-8 flex-wrap gap-2">
                            <div className="flex flex-wrap justify-center space-x-2 bg-gray-800 rounded-lg p-1">
                                {(['opc1', 'opc2', 'opc3', 'opc4', 'opc5', 'opc6'] as TabType[]).map((tab) => (
                                    ...
                                    >
                                        <span
                                            className="font-poppins font-xxl text-xs sm:text-sm md:text-base uppercase">{tab}</span>
                                    </button>
                                ))}
                            </div>
                        </div>
                                ...
                                {data?.[activeTab]?.length ? (
                                    data[activeTab].map((student) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-1 sm:px-6 py-4 whitespace-nowrap">
                                                <div
                                                    className="text-sm text-gray-300 font-poppins">{student.username}</div>
                                            </td>
                                            <td className="px-1 sm:px-6 py-4 whitespace-nowrap">
                                                <div
                                                    className="text-sm text-gray-300 font-poppins">{student.solved}</div>
                                            </td>
                                        </tr>
                                    ))
                                ) : (
