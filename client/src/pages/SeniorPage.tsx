...
const SeniorPage = () => {
    ...
    return (
        <div className="relative min-h-screen py-10 px-4 flex justify-center items-center ">
            <MouseEffectBackground/>
            <div
                className="bg-neutral-900 max-w-[90%] mx-auto rounded-2xl shadow-lg p-6 flex flex-col lg:flex-row gap-6 relative grow">
                {/* Left: Profile */}
                <div className="flex flex-col items-center w-full">
                    <div className="w-52 h-52 rounded-full overflow-hidden border-4 border-white shadow">
                        {senior.photoUrl ? (
                            ...
                            <div
                                className="w-full h-full bg-gray-500 flex items-center justify-center text-4xl font-bold text-white">
                                ...
                                return (
                                    ...
                                    >
                                        <p className="font-bold text-lg">
                                            ...
                                            {offerDate && (
                                                <span
                                                    className="text-sm font-normal text-gray-200"> ({offerDate})</span>
                                            )}
                                        </p>
